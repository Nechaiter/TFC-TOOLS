export function GreedyAlgorithm(target_pos, steps_available) {
...
export function short_path(target_pos, steps_available) {
    const startTime = performance.now();
...
//# sourceMappingURL=forge_steps_algorithms.js.map